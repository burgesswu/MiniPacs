package com.carlwu.minipacs.ui;
...
public class UiConsts {
     ...
     * 软件名称,版本
     */
    public final static String APP_NAME = "MINIPACS";
    ...
    public final static Image IMAGE_ICON = Toolkit.getDefaultToolkit()
            .getImage(App.class.getResource("/icon/logo.png"));
    ...
    public final static ImageIcon ICON_DATA_SYNC = new ImageIcon(
            App.class.getResource("/icon/logo.png"));
    // 工具栏图标
    /**
     * 状态 默认
     */
    ...
    public final static ImageIcon ICON_LOGIN = new ImageIcon(
            App.class.getResource("/icon/jurassic_next.png"));
    public final static ImageIcon ICON_EXIT = new ImageIcon(
            App.class.getResource("/icon/shinshoptuichudenglu.png"));
    /**
     * 表字段对应关系 失效
     */
    ...
    public final static Dimension PANEL_ITEM_SIZE_CUSTOMER = new Dimension(1300, 60);
